            ...
            <main className="min-h-screen bg-gradient-to-br from-amber-50/50 via-orange-50/20 to-amber-50/30">
                <div className="flex">
                    ...
                    <div className="flex-1 p-6 max-w-6xl">
                        ...
                        {/* Loading State */}
                        {loading && (
                            <div className="flex flex-col items-center justify-center py-20 animate-fadeSlideIn">
                                <div className="relative">
                                    <div className="w-16 h-16 rounded-full border-4 border-amber-200 border-t-orange-500 animate-spin" />
                                ...
                                <p className="text-lg font-medium text-amber-700 mt-6">Loading requests...</p>
                                <p className="text-sm text-amber-500 mt-1">Please wait a moment</p>
                            </div>
                        )}
