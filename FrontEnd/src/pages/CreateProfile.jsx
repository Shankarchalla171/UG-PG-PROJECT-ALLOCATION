        ...
        <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 flex">
          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="bg-white rounded-2xl shadow-lg border border-orange-200/60 p-10 text-center max-w-md w-full">
              ...
              <h2 className="text-2xl font-bold text-amber-900 mb-2">Profile Created!</h2>
              <p className="text-amber-600/70 text-sm">Your profile has been set up successfully.</p>
              <a
                href="/dashboard"
      ...
      <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 flex">
        ...
        <div className="flex-1 p-6">
          <div className="max-w-2xl mx-auto">
            ...
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-amber-800">Create Profile</h1>
            ...
            {!selectedRole ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-amber-900 mb-1">Student</h3>
                  <p className="text-amber-500 text-sm leading-relaxed">
                    Set up your student profile with roll number, department, and resume.
                  </p>
                </button>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-amber-900 mb-1">Professor</h3>
                  <p className="text-amber-500 text-sm leading-relaxed">
                    Set up your faculty profile with research domain and office details.
                  </p>
                </button>
              </div>
            ) : (
              ...
              >
                ...
                {selectedRole === "student" ? (
                  <>
                    ...
                    <div className={FIELD_CLASS}>
                      <label htmlFor="collegeEmail" className={LABEL_CLASS}>College Email *</label>
                      <input
                        type="email"
                        id="collegeEmail"
                        name="collegeEmailId"
                    ...
                    <div className={FIELD_CLASS}>
                      <label htmlFor="rollNumber" className={LABEL_CLASS}>Roll Number *</label>
                      <input
                        type="text"
                        id="rollNumber"
                        name="rollNo"
                  ...
                  <>
                    <div className={FIELD_CLASS}>
                      <label htmlFor="profName" className={LABEL_CLASS}>Name *</label>
                      <input
                        type="text"
                        id="profName"
                        name="name"
                    ...
                    <div className={FIELD_CLASS}>
                      <label htmlFor="profEmail" className={LABEL_CLASS}>Email *</label>
                      <input
                        type="email"
                        id="profEmail"
                        name="email"
                    ...
                    <div className={FIELD_CLASS}>
                      <label htmlFor="profDepartment" className={LABEL_CLASS}>Department *</label>
                      <select
                        id="profDepartment"
                        name="departmentName"
                    ...
                    <div className={FIELD_CLASS}>
                      <label htmlFor="researchDomain" className={LABEL_CLASS}>Research Domain *</label>
                      <input
                        type="text"
                        id="researchDomain"
                        name="domain"
