        ...
        <aside className='side w-64 min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 border-r border-orange-200/60 flex flex-col transition-all duration-300 shadow-lg'>
            ...
            <nav className='flex flex-col gap-4 px-4 flex-1'>
                <NavLink to="/projects" className={navLinkClasses}>
                    ...
                    <span className='links opacity-100 w-auto whitespace-nowrap overflow-hidden transition-all duration-300 font-medium'>Projects Available</span>
                </NavLink>
                ...
                {role === "faculty" && (
                    <div className='mt-4 pt-4 border-t border-orange-200/60 flex flex-col gap-2'>
                        <p className='links text-xs uppercase tracking-wider text-amber-600 font-semibold px-4 mb-1'>Faculty</p>
                        <NavLink to="/request" className={navLinkClasses}>
                            <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/>
                            </svg>
                            <span className='links opacity-100 w-auto whitespace-nowrap overflow-hidden transition-all duration-300 font-medium'>Requests</span>
                        </NavLink>
                        <NavLink to="/confromation" className={navLinkClasses}>
                            <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/>
                            </svg>
                            <span className='links opacity-100 w-auto whitespace-nowrap overflow-hidden transition-all duration-300 font-medium'>Confirmation</span>
                        </NavLink>
                    </div>
                )}
            </nav>
